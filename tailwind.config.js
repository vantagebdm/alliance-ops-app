...
module.exports = {
  ...
  safelist: [
    ...
    'bg-orange-500/5', 'border-orange-500', 'bg-green-500/5', 'border-green-500', 'bg-amber-500/5', 'border-amber-500', 'bg-gray-500/5', 'border-gray-500', 'bg-red-500/5', 'border-red-500',
  ],
  theme: {
    extend: {
      fontFamily: {
