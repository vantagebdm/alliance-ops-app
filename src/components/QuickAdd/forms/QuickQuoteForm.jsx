...
export default function QuickQuoteForm({ onClose, onSaved }) {
  ...
  const fillCustomer = (item) => {
    setForm(f => ({
      ...
      company: item.trading_name || item.company || f.company,
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-background">
      ...
      <div className="bg-[hsl(0,0%,6%)] px-6 py-3 flex items-center justify-between flex-shrink-0">
        <h2 className="font-heading text-lg font-bold text-white uppercase tracking-wider">New Quote</h2>
        ...
        <div className="w-80 flex-shrink-0 border-r border-border bg-card p-5 flex flex-col gap-4 overflow-y-auto">
          <div>
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="font-heading text-[10px] uppercase tracking-wider text-foreground/50 mb-1 block">Company / Business Name</label>
                <Autocomplete
                  value={form.company}
