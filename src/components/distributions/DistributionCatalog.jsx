...
import { TOTAL_ENERGIES_PRODUCTS, TOTAL_ENERGIES_CATEGORIES, DISTRIBUTION_SUPPLIERS } from "@/lib/distributionData";
          ...
          <tbody>
            {filtered.map((p, i) => (
              <tr key={p.sku + i} className="border-t border-[hsl(0,0%,14%)] hover:bg-white/5">
                ...
                <td className="px-3 py-2 text-right text-white/60">{fmt(p.unit_price)}</td>
