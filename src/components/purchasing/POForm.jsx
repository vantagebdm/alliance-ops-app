        ...
        <div className="p-6 space-y-6">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-heading text-sm font-semibold uppercase tracking-wider">Supplier & Order Details</h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-heading text-sm font-semibold uppercase tracking-wider">Order Lines</h3>
            </div>
          ...
          <div>
            ...
            <Textarea value={form.notes} onChange={e => u("notes", e.target.value)}
              placeholder="Special instructions, freight notes..." className="rounded-sm" rows={2} />
          </div>
        </div>
