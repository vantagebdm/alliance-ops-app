          ...
          <div className="flex-1 border border-border rounded-sm overflow-auto">
             <table className="text-sm border-collapse">
               <thead className="bg-[hsl(0,0%,11%)] border-b border-border sticky top-0">
                 <tr>
                    <th className="text-left px-3 py-1 font-heading text-[9px] uppercase tracking-wider text-foreground/50 w-32 border-r border-border">Part #</th>
                    <th className="text-left px-3 py-1 font-heading text-[9px] uppercase tracking-wider text-foreground/50 flex-1 border-r border-border">Description</th>
                    <th className="text-right px-3 py-1 font-heading text-[9px] uppercase tracking-wider text-foreground/50 w-16 border-r border-border">Qty</th>
                    <th className="text-right px-3 py-1 font-heading text-[9px] uppercase tracking-wider text-foreground/50 w-24 border-r border-border">Unit Cost</th>
                    <th className="text-right px-3 py-1 font-heading text-[9px] uppercase tracking-wider text-foreground/50 w-24">Total</th>
                    <th className="w-8" />
                 </tr>
               </thead>
               <tbody>
                 {form.items.map((line, i) => (
                    <tr key={i} className="border-b border-border/50">
                      <td className="px-3 py-1 w-32 border-r border-border/50">
                        <PartAutocomplete 
                      ...
                      <td className="px-3 py-1 flex-1 border-r border-border/50">
                         <input 
                      ...
                      <td className="px-3 py-1 w-16 border-r border-border/50">
                      ...
                      <td className="px-3 py-1 w-24 border-r border-border/50">
                        <Input type="number" step="0.01" value={line.unit_cost || 0} onChange={e => updateLine(i, "unit_cost", Number(e.target.value))}
                          className="rounded-sm h-7 text-xs text-right" />
                      </td>
                      <td className="px-3 py-1 w-24 text-right font-semibold text-sm">${(line.total || 0).toFixed(2)}</td>
