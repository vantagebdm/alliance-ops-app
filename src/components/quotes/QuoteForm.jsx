        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-heading text-sm font-semibold uppercase tracking-wider">Customer</h3>
            </div>
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                <label className="font-heading text-[11px] uppercase tracking-wider text-foreground/50 mb-1 block">Email</label>
            ...
            <div className="grid grid-cols-3 gap-3 mt-3">
              ...
              <div>
                <label className="font-heading text-[11px] uppercase tracking-wider text-foreground/50 mb-1 block">Valid Until</label>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-6 h-6 bg-primary flex items-center justify-center rounded-sm">
                <span className="font-heading font-bold text-black text-xs">3</span>
              </div>
              <h3 className="font-heading text-sm font-semibold uppercase tracking-wider">Notes</h3>
            </div>
            <Textarea value={form.notes} onChange={e => u("notes", e.target.value)}
              placeholder="Terms, conditions, delivery notes..." className="rounded-sm" rows={2} />
          </div>
        </div>
